      ...
      <div className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center'}>
        <ul >
          <li className='py-6 text-4xl'>
            <Link className='flex justify-center items-cente' onClick={handleClick} to="home" spy={true} smooth={true} duration={500}>
              <img className='mb-3 mr-2' src={Home} alt='Home icon' style={{ width: '35px' }} />
              Home
            </Link>
          </li>
          <li className='py-6 text-4xl'>
            <Link className='flex justify-center items-center' onClick={handleClick} to="about" spy={true} smooth={true} duration={500}>
              <img className='mb-3 mr-2' src={About} alt='About icon' style={{ width: '35px' }} />
              Sobre
            </Link>
          </li>
          <li className='py-6 text-4xl'>
            <Link className='flex justify-center items-center' onClick={handleClick} to="skills" spy={true} smooth={true} duration={500}>
              <img className='mb-3 mr-2' src={Skills} alt='Skills icon' style={{ width: '35px' }} />
              Habilidades
            </Link>
          </li>
          <li className='py-6 text-4xl'>
            <Link className='flex justify-center items-center' onClick={handleClick} to="work" spy={true} smooth={true} duration={500}>
              <img className='mb-3 mr-2' src={Work} alt='work icon' style={{ width: '35px' }} />
              Trabalho
            </Link>
          </li>
          <li className='py-6 text-4xl'>
            <Link className='flex justify-center items-center' onClick={handleClick} to="contact" spy={true} smooth={true} duration={500}>
