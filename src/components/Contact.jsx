...
const Contact = () => {
  ...
  return (
    <div name='contact' className='w-full h-full bg-[#0a192f] flex justify-center items-center p-4 mb-4'>
      ...
      <form onSubmit={handleSubmit} method='POST' className='flex flex-col max-w-[600px] w-full pt-24 pb-20'>
        <ToastContainer />
        <div className='p-8'>
